...
# La eliminación lógica se mantiene exclusiva del Director(1)
@estudiante_router.delete("/{ciestu}", status_code=status.HTTP_204_NO_CONTENT)
def delete_estudiante_logico(
    ciestu: str, 
    db: Session = Depends(get_db), 
